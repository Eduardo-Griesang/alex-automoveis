...
export default function Reasons() {
    return(
        <section className="flex flex-col py-7 lg:py-16 px-2 lg:gap-10 lg:px-10 gap-7 text-center items-center" id="sobre">
            <h3 className="font-bold text-xl lg:text-3xl pb-2 lg:pb-5 xl:pb-7">Porque escolher a Alex Automoveis</h3>
